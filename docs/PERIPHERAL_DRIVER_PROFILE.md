...
It may produce a tagged release or packaged crate artifact identified as an
Experimental or Incubating prerelease. This does not authorize crates.io
publication or a physical-device support claim.
...
> evidence from physical silicon. It is not published to crates.io and must not
> be treated as datasheet-conformant or hardware-qualified.
